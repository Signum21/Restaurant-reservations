...
function cerca(){	
	...
	$.ajax({
		...
		function(response){
			if(response === ''){
				$('#locali').append('<tr class="'+counter+'"><td colspan="3" align="center"><p><font color="red"><img src="Images/error piccolo.png" style="vertical-align:top"> Nessun risultato</font></p></td></tr>');
			}
			else{
