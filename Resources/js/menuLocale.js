...
function aggiungiMenu(Id){
	...
	if(counter <= 0){
		$.ajax({ 
			type: "POST", url: 'Resources/php/menuLocale.php?Tipo='+Tipo+'&Nome='+Nome+'&Prezzo='+Prezzo+'&Ingredienti='+Ingredienti+'&LocaleId='+Id+'&Val='+'Aggiungi&counter='+conta, data: formData, 
