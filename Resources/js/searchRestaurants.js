...
function displaySearchResult(response){
	if(response === ''){
		$('#restaurants').append('<tr class="'+counter+'"><td colspan="3" align="center"><p><font color="red"><img src="Resources/Images/smallError.png" style="vertical-align:top"> Nessun risultato</font></p></td></tr>');
	}
	else{
		...
		for(let a = 0; a < res.length-1; a++){
			...
			let img = (res2[2] !== '') ? 'data:image;base64,'+res2[2] : 'Resources/Images/white.png';
